                ...
                <table className="table-fixed w-full  bg-blue-300 rounded-md">
                    <thead className="uppercase bg-red-500">
                        <tr>
                            ...
                            <th className="w-[15%] py-2">data</th>
                            <th className="w-[20%] py-2">Name customer</th>
                            <th className="w-[20%] py-2">product</th>
                            <th className="w-[15%] py-2">Total Price</th>
                            <th className="w-[10%] py-2">Payment</th>
